...
clin <- cbind(clin_merged[, selected_cols], "Lung", NA , NA, NA, NA, NA ,NA ,NA )

# Set new column names.
colnames(clin) <- c(
  "patient", "age", "recist", "t.os", "t.pfs", "histo", "stage", "sex", "os",
  "pfs", "primary", "dna", "dna_info", "rna", "rna_info" , "drug_type", "response.other.info", "response")
...
clin <- add_column(clin, treatmentid= clin_merged$Agent_PD1, .after='tissueid')
